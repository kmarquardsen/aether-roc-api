...
oapi-codegen-aether-app-gtwy: oapi-codegen
	...
	oapi-codegen \
    	-generate types \
    	-package types \
		-o pkg/app_gtwy/types/aether-app-gtwy-types.go \
	 	api/aether-app-gtwy-openapi3.yaml
	oapi-codegen \
    	-generate spec \
    	-package server \
		-o pkg/app_gtwy/server/aether-app-gtwy-spec.go \
	 	api/aether-app-gtwy-openapi3.yaml
	#oapi-codegen \
#		-generate types,server \
#		-import-mapping externalRef0:"github.com/onosproject/aether-roc-api/pkg/aether_2_0_0/types",externalRef1:"github.com/onosproject/config-models/modelplugin/aether-2.0.0/aether_2_0_0" \
#		-package server \
#		-templates pkg/codegen/templates \
#		-o pkg/app_gtwy/server/aether-app-gtwy-impl.go \
#		api/aether-app-gtwy-openapi3.yaml
	#sed -i "s/target Target/target externalRef0.Target/g" pkg/app_gtwy/server/aether-app-gtwy-impl.go
	oapi-codegen \
		-generate server \
		-import-mapping externalRef0:"github.com/onosproject/aether-roc-api/pkg/aether_2_0_0/types" \
		-package server \
	...
	#for f in pkg/app_gtwy/**/aether-app-gtwy*.go; do sed -i '1i// Code generated by oapi-codegen. DO NOT EDIT.' $$f; done
